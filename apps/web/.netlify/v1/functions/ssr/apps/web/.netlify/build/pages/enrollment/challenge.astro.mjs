...
const $$Challenge = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const claveParam = Astro2.url.searchParams.get("clave");
    ...
    claveButton?.addEventListener("click", async () => {
      ...
      if (claveErrorBox) {
        ...
        claveErrorBox.textContent =
          detail || "No se pudo iniciar la validaci\xF3n con Clave\xDAnica. Intenta de nuevo.";
